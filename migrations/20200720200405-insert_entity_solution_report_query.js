...
module.exports = {
  async up(db) {
    global.migrationMsg = "Insert entity solution report query";
    ...
    const result = await cassandra.execute(query, ['entity_solution_report_query'], { prepare: true });
