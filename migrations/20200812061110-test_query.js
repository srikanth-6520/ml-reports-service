...
module.exports = {
  async up(db) {
    global.migrationMsg = "Insert test query";
    ...
    const result = await cassandra.execute(query, ['test_query_5'], { prepare: true });
