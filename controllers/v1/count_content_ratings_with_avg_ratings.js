...
exports.countcontentratingswithaverageratings = async function (req, res) {
    try{
    const_data['getParams']['Key'] = 'mantra/top_content_ratings/count_content_ratings_with_avg.csv'
