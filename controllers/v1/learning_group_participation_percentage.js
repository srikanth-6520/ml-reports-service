...
exports.learning_group_participation_percentage = async function (req, res) {
    try{
    const_data['getParams']['Key'] = 'mantra/group_participation_percentage/group_participation_percentage.csv'
